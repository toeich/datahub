...
public class DatasinkSchemaEditor extends CustomComponent {
		...
		schemaTree.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				if (itemId instanceof Input) {
					detailsPanel.setContent(new DatasinkSchemaInputEditor((Input) itemId));
				} else {
	...
	public void setSchema(ComponentSchema schema) {
		schemaTree.setContainerDataSource(new DatasinkSchemaContainer(schema));
	}
