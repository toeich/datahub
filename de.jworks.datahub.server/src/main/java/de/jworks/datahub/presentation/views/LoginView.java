...
public class LoginView extends CustomComponent implements View, Constants {
	...
	public LoginView() {
		...
		signInButton.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				navigator.navigateTo(nextState);
			}
		});
	}
	...
	public void enter(ViewChangeEvent event) {
		...
		if (nextState == null) {
			navigator.navigateTo(USER_VIEW);
			return;
		}
		
		Page.getCurrent().setTitle(Messages.getString("LoginView_title"));
	...
	private HorizontalLayout buildHeaders() {
		...
		header2.setValue("jworks Connector");
