...
public class ProjectNewView extends CustomComponent implements View {
	...
	public ProjectNewView() {
		...
		label.setValue(Icon.home + " / Projects / New Project");

		final Project project = new Project();
		Form form = new Form();
		form.setItemDataSource(new BeanItem<Project>(project), Arrays.asList("name", "description"));
	...
	private VerticalLayout buildProjectTab() {
		...
		formContainer.setImmediate(false);
		formContainer.setWidth("100.0%");
		formContainer.setHeight("100.0%");
		formContainer.setMargin(false);
		projectTab.addComponent(formContainer);
		projectTab.setExpandRatio(formContainer, 1.0f);
