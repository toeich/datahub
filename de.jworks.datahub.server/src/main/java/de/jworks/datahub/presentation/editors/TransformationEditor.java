...
public class TransformationEditor extends CustomComponent {
	...
	@AutoGenerated
	private TransformationDefinitionEditor definitionEditor;
	@AutoGenerated
	...
	public TransformationEditor(final Transformation transformation, List<Datasink> datasinks, List<Datasource> datasources) {
		buildMainLayout();
		...
		fieldGroup.setItemDataSource(new BeanItem<Transformation>(transformation));
		fieldGroup.bindMemberFields(this);

		definitionEditor.setData(transformation.getDefinition(), datasinks, datasources);
		...
		okButton.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				try {
					...
					fireEvent(new SaveEvent(TransformationEditor.this, transformation));
		...
		cancelButton.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				fieldGroup.discard();
				fireEvent(new SaveEvent(TransformationEditor.this, null));
			}
		});
	}
	...
	public static class SaveEvent extends Event {
		...
		public SaveEvent(Component source, Transformation transformation) {
			super(source);
	...
	private VerticalLayout buildMainLayout() {
		...
		// definitionEditor
		definitionEditor = new TransformationDefinitionEditor();
		definitionEditor.setImmediate(false);
		definitionEditor.setWidth("100.0%");
		definitionEditor.setHeight("-1px");
		mainLayout.addComponent(definitionEditor);
