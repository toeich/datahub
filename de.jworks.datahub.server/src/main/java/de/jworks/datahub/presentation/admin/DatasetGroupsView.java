...
@CDIView(value = "alldatasetgroups", uis = { AdminUI.class })
public class DatasetGroupsView extends CustomComponent implements View {
	...
	public DatasetGroupsView() {
		...
		datasetGroupsTable.addGeneratedColumn("actions", new ColumnGenerator() {
			@Override
			public Object generateCell(Table source, Object itemId, Object columnId) {
				final DatasetGroup datasetGroup = datasetGroups.getItem(itemId).getBean();
				...
				removeButton.addClickListener(new ClickListener() {
					@Override
					public void buttonClick(ClickEvent event) {
						datasetService.removeDatasetGroup(datasetGroup);
		...
		addDatasetGroupButton.addClickListener(new ClickListener() {
			@Override
			public void buttonClick(ClickEvent event) {
