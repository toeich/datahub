...
public class AccountHeader extends CustomComponent {
	...
	public void attach() {
		...
		MenuItem showProfileItem = menuBar.addItem("<li class='icon-user'></li> " + user.getFullName(), new Command() {
			@Override
		...
		MenuItem dashboardItem = menuBar.addItem("<li class='icon-dashboard'></li> 0", new Command() {
			@Override
			public void menuSelected(MenuItem selectedItem) {
		...
		MenuItem editProfileItem = menuBar.addItem("<li class='icon-cog'></li>", new Command() {
			@Override
			public void menuSelected(MenuItem selectedItem) {
				UI.getCurrent().getNavigator().navigateTo("dashboard!/");
			}
		...
		MenuItem signOutItem = menuBar.addItem("<li class='icon-signout'></li>", new Command() {
			@Override
			public void menuSelected(MenuItem selectedItem) {
				try {
