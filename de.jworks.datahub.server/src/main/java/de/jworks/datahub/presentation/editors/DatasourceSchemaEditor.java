...
public class DatasourceSchemaEditor extends CustomComponent {
		...
		schemaTree.addActionHandler(new Handler() {
			...
			public Action[] getActions(Object target, Object sender) {
				...
				if (target instanceof Output) {
					...
					if (output.getType() == ItemType.XML_ELEMENT) {
			...
			public void handleAction(Action action, Object sender, Object target) {
				if (target instanceof Output) {
					...
					if (action == addElement) {
						...
						parent.removeOutput((Output) target);
					}
		...
		schemaTree.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				if (itemId instanceof Output) {
					detailsPanel.setContent(new DatasourceSchemaOutputEditor((Output) itemId));
				} else {
	...
	public void setSchema(ComponentSchema schema) {
		schemaTree.setContainerDataSource(new DatasourceSchemaContainer(schema));
	}
