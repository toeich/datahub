...
public class Header2 extends CustomComponent {
	...
	public Header2() {
		...
		processesButton.addClickListener(new ClickListener() {
			@Override
			public void buttonClick(ClickEvent event) {
				UI.getCurrent().getNavigator().navigateTo("processes");
			}
		});
	}
	...
	private HorizontalLayout buildMainLayout() {
		...
		processesButton.setStyleName("link");
		processesButton.setCaption("Processes");
		processesButton.setImmediate(true);
		processesButton.setWidth("-1px");
		processesButton.setHeight("-1px");
		mainLayout.addComponent(processesButton);
		mainLayout.setComponentAlignment(processesButton, new Alignment(48));
