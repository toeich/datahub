...
public class DatasetSchemaEditor extends CustomComponent {
	...
	public void setDatasetSchema(DatasetSchema datasetSchema) {
		schemaTree.setContainerDataSource(new DatasetSchemaContainer(datasetSchema));
		...
		schemaTree.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				if (itemId instanceof Element) {
					detailsPanel.setContent(new DatasetSchemaElementEditor((Element) itemId));
				} else if (itemId instanceof Attribute) {
					detailsPanel.setContent(new DatasetSchemaAttributeEditor((Attribute) itemId));
				} else {
		...
		schemaTree.expandItemsRecursively(datasetSchema.getRootElement());
		schemaTree.select(datasetSchema.getRootElement());
	}
